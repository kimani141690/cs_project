...
<div class="page-wrapper p-t-180 p-b-100 font-robo" style="background-color:#006A4E;">
    <div class="wrapper wrapper--w960">
        <div class="card card-2">
            ...
            <div class="card-body">
                <h4 class="title">Farmer Registration Page</h4>
                <form method="POST" action="/auth/registration">
                    @csrf
                    <div>
                        <div>
                            <div class="input-group">
                                <input class="input--style-2" type="text" placeholder="User Name " name="name">
                            </div>
                        </div>
                        ...
                        <div>
                            <div>
                                <div class="input-group">
                                    <input class="input--style-2" type="text" placeholder="Contact " minlength="8"
                                           name="contact">
                                </div>
                            </div>
                        </div>
